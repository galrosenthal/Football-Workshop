...
public class UserRoles extends TableImpl<UserRolesRecord> {
    ...
    private static final long serialVersionUID = 2115209962;

    /**
     * The reference instance of <code>fwdb.user_roles</code>
     */
    ...
    /**
     * The column <code>fwdb.user_roles.username</code>.
     */
    ...
    /**
     * The column <code>fwdb.user_roles.role_type</code>.
     */
    public final TableField<UserRolesRecord, UserRolesRoleType> ROLE_TYPE = createField(DSL.name("role_type"), org.jooq.impl.SQLDataType.VARCHAR(26).nullable(false).asEnumDataType(DB.Tables.enums.UserRolesRoleType.class), this, "");

    /**
     * Create a <code>fwdb.user_roles</code> table reference
     */
    public UserRoles() {
    ...
    /**
     * Create an aliased <code>fwdb.user_roles</code> table reference
     */
