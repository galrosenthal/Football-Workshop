...
//                    System.out.println("Waiting for the user input");
    ...
    public static int receiveInt(String messageToDisplay, Collection<String>... valuesToDisplay) throws CancellationException{
        if (!isTest) {
            ...
            else if (selector == 6132 || selector == 6133 || selector == 6134 || selector == 6136 || selector == 6137  || selector == 61341   || selector == 6135 || selector == 61310
                    || selector == 6138 || selector == 61383 || selector == 61381)
            {
                if (selector == 6134) {
                    selector = 61341;
